...
void conversor(int base_original, int base_convertida)
{
	...
	if(base_original == 2 && base_convertida == 10) //Done
	{
	...
	else if(base_original == 2 && base_convertida == 16) //Done
	{
		for(i = 0; num_bin[i] != '\0'; i++);
		i--;
		for(int k = i; k >= 0; k--)
	...
	else if(base_original == 16 && base_convertida == 10) //Done
	{
	...
	else if(base_original == 10 && base_convertida == 2) //Done
	{
		for(i = 0; num >= 1; i++)
		{ 
			num_convertido[i] = num % base_convertida;
	...
	else if(base_original == 10 && base_convertida == 16) //Done
	{
		/*for(i = 0; num >= 1; i++)
		{ 
			num_convertido[i] = num % base_convertida;
		...
		for(int j = i; j >= 0; j--)
		{
			if(num_convertido[j] == 10) num_convertido[j] = 'a';
			else if(num_convertido[j] == 10) num_convertido[j] = 'b';
			else if(num_convertido[j] == 10) num_convertido[j] = 'c';
			else if(num_convertido[j] == 10) num_convertido[j] = 'd';
			else if(num_convertido[j] == 10) num_convertido[j] = 'e';
			else if(num_convertido[j] == 10) num_convertido[j] = 'f';
		}
	...
	else if(base_original == 8 && base_convertida == 10) //Done
	{
		printf("\nNumero convertido: %d", num);
	}
	else if(base_original == 10 && base_convertida == 8) //Done
	{
		for(i = 0; num >= 1; i++)
		{ 
			num_convertido[i] = num % base_convertida;
